...
export const THOUGHTDECK_HOME_URL = "https://thought-deck.vercel.app/";
...
export const demoOutput = `Day2では、NPVやIRRといった定量指標の重要性を再認識するとともに、それだけでは意思決定を説明できないケースについて深く考えさせられた。
