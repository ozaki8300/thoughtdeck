            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="grid gap-2 sm:hidden">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    onClick={pickVault}
                    className="rounded-lg border border-[var(--td-border-strong)] px-3 py-2 text-sm text-[var(--td-text)] transition hover:border-[var(--td-accent-border)] hover:bg-[var(--td-hover)]"
                  >
                    📁 Vaultを選択
                  </button>
                  <button
