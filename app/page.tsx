  ...
  const createShare = async () => {
    try {
      ...
      try {
        ...
        localStorage.setItem(QR_HISTORY_STORAGE_KEY, JSON.stringify(nextHistory));
      } catch {
        localStorage.setItem(QR_HISTORY_STORAGE_KEY, JSON.stringify([qrHistoryItem]));
      }
